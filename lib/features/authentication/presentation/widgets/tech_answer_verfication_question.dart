...
class TechAnswerVerficationQuestion extends StatelessWidget {
  const TechAnswerVerficationQuestion({super.key, required this.answerController});
    ...
    return Column(
      ...
      children: [
        GenericDataView<QuestionCubit, String>.fromState(
          buildLoadedWidgetWithState: (state) => Column(children: [Container(
            ...
            child:  Row(
              ...
              children: [
                state is LoadedState<String>
                    ...
                    : SizedBox(height: 10, width: 10, child: CircularProgressIndicator(color: AppColors.primaryColor)),
                ...
                Expanded(child:   Align(
                  ...
                  child: AnimatedSwitcher(
                    ...
                    child: Text(state is LoadedState<String> ? state.data : AppStrings.merchantCheckHintAr,
           ...
           AnimatedSwitcher(duration: 100.microseconds,
           child: state is LoadedState? Padding(padding: getPadding(start: 16.h,),
        ...
        BlocBuilder<ErrorCubit, CubitStates>(
          builder: (context, state) {
            return ErrorText(
              showError: context.read<ErrorCubit>().errors.contains(Errors.VERIFICATION_ERROR),

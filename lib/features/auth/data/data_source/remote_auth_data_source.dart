...
class AuthRemoteDataSourceImpl extends RemoteExecuteImpl implements AuthRemoteDataSource {
  ...
  @override
  Future<ResponseModel> forgetPassword({required EnterPhoneNumberRequestModel enterPhoneNumberRequestModel}) => addData(
  ...
  @override
  Future<ResponseModel> resetPassword({required ResetPasswordRequestModel resetPasswordRequestModel}) => addData(

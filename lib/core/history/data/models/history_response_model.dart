...
class HistoryResponseModel extends ListResponseModel<HistoryModel>{
  ...
  Function(Map<String, dynamic> data) get getFromJsonFunction => HistoryModel.fromJson;
...
class Detail {
  ...
  String? productName;
  String? serialNumber;
Detail copyWith({  String? productName,
  String? serialNumber,
}) => Detail(  productName: productName ?? this.productName,

...
class AppAssets {
  ...
  static  String rightArrow = '${SvgImages.svgPath}right_arrow.svg';
  static  String leftArrow = '${SvgImages.svgPath}left_arrow.svg';
  static  String downArrow = '${SvgImages.svgPath}right_arrow.svg';
  static  String email = '${SvgImages.svgPath}email.svg';
  static  String eye = '${SvgImages.svgPath}eye.svg';
  static  String name = '${SvgImages.svgPath}name.svg';
  static String password="${SvgImages.svgPath}password.svg";
  static  String phone = '${SvgImages.svgPath}phone.svg';
  static  String question = '${SvgImages.svgPath}question.svg';
